...
var SSPP = require( [ "jquery", "stringUtil", "security", "mcomjs/components/media/CarouselController" ], function ( $, stringUtil, security, CarouselController ) {
  var selfSelect = {};
